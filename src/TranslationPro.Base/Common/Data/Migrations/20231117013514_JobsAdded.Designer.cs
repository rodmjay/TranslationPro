...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TranslationPro.Base.Entities.Engine", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TranslationPro.Base.Entities.EngineLanguage", b =>
                {
                    b.Property<string>("LanguageId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TranslationPro.Base.Entities.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Job", "TranslationPro");
                });

            modelBuilder.Entity("TranslationPro.Base.Entities.JobLanguage", b =>
                {
                    ...
                    b.ToTable("JobLanguage", "TranslationPro");
                });

            modelBuilder.Entity("TranslationPro.Base.Entities.JobPhrase", b =>
                {
                    b.Property<int>("JobId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("JobId", "PhraseId");

                    b.HasIndex("PhraseId");

                    b.ToTable("JobPhrase", "TranslationPro");
                });
            ...
            modelBuilder.Entity("TranslationPro.Base.Entities.MachineTranslation", b =>
                {
                    b.Property<int>("EngineId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TranslationPro.Base.Entities.Phrase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TranslationPro.Base.Entities.ApplicationPhrase", b =>
                {
                    ...
                    b.HasOne("TranslationPro.Base.Entities.Phrase", "Phrase")
                        .WithMany("Applications")
            ...
            modelBuilder.Entity("TranslationPro.Base.Entities.EngineLanguage", b =>
                {
                    b.HasOne("TranslationPro.Base.Entities.Engine", "Engine")
                        .WithMany("Languages")
            ...
            modelBuilder.Entity("TranslationPro.Base.Entities.JobLanguage", b =>
                {
                    b.HasOne("TranslationPro.Base.Entities.Job", "Job")
                        .WithMany("Languages")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TranslationPro.Base.Entities.MachineTranslation", b =>
                {
                    ...
                    b.HasOne("TranslationPro.Base.Entities.EngineLanguage", "Language")
                        .WithMany("MachineTranslations")
